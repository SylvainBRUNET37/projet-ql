    ...
    <div class="filter-container">
      ...
      <div class="tags">
        <div class="container" v-for="type in allTypes" :key="type">
          <span class="tag is-info is-light is-hoverable" @click="filterEquipements(type)"
            >{{ type }}
          </span>
        </div>
      </div>
    ...
    <div class="content-container">
      ...
      <div class="search-bar">
        <input
          ...
          v-model="search"
          v-on:keyup.enter="searchEquipments"
        />
      ...
      <div class="fixed-grid has-auto-count">
        <div class="grid">
          <div
            ...
            v-for="equipment in equipmentToDisplay"
            :key="equipment.id"
          >
  ...
  setup() {
    ...
    function searchEquipments() {
      if (search.value.trim() === '') {
        ...
        alert('None of the equipment corresponds to the research')
      } else {
    ...
    function filterEquipements(type: string) {
      filteredEquipments.value = allEquipments.value.filter(
        (equipment) => equipment.type.toLowerCase() === type.toLowerCase(),
      )
    }
